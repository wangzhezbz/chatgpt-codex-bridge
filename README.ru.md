...
<table>
  <tr>
    <td width="50%" align="center"><strong>▣ Windows</strong><br /><sub>Проверено в реальной среде</sub></td>
    <td width="50%" align="center"><strong>◇ macOS</strong><br /><sub>Запуск из исходного кода · полная проверка ожидается</sub></td>
  </tr>
</table>
...
2. Распакуйте архив в постоянную папку, например `D:\Apps\CodexBridge`.
3. Прочитайте `INSTALL-CodexBridge.md` и запустите `Start-CodexBridge.cmd`.
4. Откройте `http://127.0.0.1:4317/`.
